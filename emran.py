...
class PomodoroTimer:
    def __init__(self, master):
        ...
        # Music Player Window
        self.music_image = PhotoImage(file="note2.png").subsample(16,16)
        self.music_button = Button(master, image=self.music_image,command = open_musicplayer)
        self.music_button.place(relx=0.4, rely=0.7)
